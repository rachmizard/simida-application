                ...
                <div class="panel-body container-fluid" style="background-color: #fdfdfd;">
                    <div class="row row-lg">
                        <div class="col-md-12">
                            ...
                            <form @submit.prevent="updatesemester" autocomplete="off">
                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <input v-model="semester.tingkat_semester" type="text" class="form-control" placeholder="Tahun baru.." autocomplete="off" />
                                                        <span v-if="errors.tingkat_semester" class="badge badge-danger">{{ errors.tingkat_semester[0] }}</span>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <span v-if="errors.periode_id" class="badge badge-danger">{{ errors.periode_id[0] }}</span>
                                                </div>
                                            </div>
                                            <div class="form-row">
	  ...
	  components: {
        ...
        methods: {
            ...
            getSemesterById(){
                ...
                axios.get('/pendidikan/semester/'+ id +'/show').then(response => {
                    this.semester.tingkat_semester = response.data.tingkat_semester;
                    this.semester.periode_id = response.data.periode_id;
                })
            },

            updatesemester:function(e){
                let app = this;
                var semester = app.semester;
                var id = app.$route.params.id;
                axios.put('/pendidikan/semester/'+ id +'/update', semester)
                .then(function (resp) {
                  app.errors = [];
