                ...
                <div class="panel-body container-fluid" style="background-color: #fdfdfd;">
                    <div class="row row-lg">
                        <div class="col-md-12">
                            ...
                            <form @submit.prevent="updatekegiatan" autocomplete="off">
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12" style="padding-right: 15px;">
                                    <h4 class="example-title"><i class="icon wb-book"></i> Edit Kegiatan</h4>
                                        <div class="example">
                                            <div class="form-row">
                                                <div class="row">
                                                    <div class="col-md-4">
      ...
      components: {
        ...
        methods: {
            function(){
                ...
                axios.get('/pendidikan/kegiatan/'+ this.$route.params.id +'/show').then(response => {
                 this.kegiatan.nama_kegiatan = response.data.nama_kegiatan;
                 this.kegiatan.mulai_kegiatan = response.data.mulai_kegiatan;
                 this.kegiatan.akhir_kegiatan = response.data.akhir_kegiatan;
                 this.kegiatan.nilai_kegiatan = response.data.nilai_kegiatan;
                })
            },

            updatekegiatan:function(e){
                let app = this;
                var body = app.kegiatan;
                var id = app.$route.params.id;
                axios.put('/pendidikan/kegiatan/'+ id +'/update', body)
                .then(function (resp) {
                  app.errors = [];
