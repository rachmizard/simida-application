            ...
            <div class="panel-body container-fluid" style="background-color: #fdfdfd;">
                <div class="row row-lg">
                    <div class="col-md-12">
                        ...
                        <form @submit.prevent="storejadwalpelajaran" autocomplete="off">
                        <div class="form-row">
                            <div class="form-group col-md-12 col-sm-12" style="padding-right: 15px;">
                                <h4 class="example-title"><i class="icon wb-time"></i> Edit Jadwal Pelajaran</h4>
                                    <div class="example">
                                        <div class="form-row">
                                        	<div class="row">
                                        		<div class="col-md-3">
	  ...
	  components: {
        ...
        methods: {
        	function(){
                ...
                axios.get('/pendidikan/jadwalpelajaran/'+ this.$route.params.id +'/show').then(response => {
                    this.jadwalpelajaran.mata_pelajaran_id = response.data.mata_pelajaran_id;
                    this.jadwalpelajaran.guru_id = response.data.guru_id;
                    this.jadwalpelajaran.kelas_id = response.data.kelas_id;
                    this.jadwalpelajaran.hari = response.data.hari;
                    this.jadwalpelajaran.semester_id = response.data.semester_id;
                    this.jadwalpelajaran.jam_masuk = response.data.jam_masuk;
                    this.jadwalpelajaran.jam_selesai = response.data.jam_selesai;
                    this.jadwalpelajaran.periode = response.data.periode;                
                })
        	},
            ...
            storejadwalpelajaran:function(e){
                ...
                axios.put('/pendidikan/jadwalpelajaran/'+ app.$route.params.id +'/update', body)
                .then(function (resp) {
                  app.errors = [];
