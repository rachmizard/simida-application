...
@section('content')
        <div class="row">
            ...
            <div class="col-md-12">                
                <div class="panel">
                    <div class="panel-body container-fluid" style="background-color: #fdfdfd;">
                        <h4 class="example-title"><i class="icon wb-random"></i> Hasil Perekapan Absensi</h4>
                        <div class="row row-lg">
                                    ...
                                    <tr>
                                        ...
                                        @foreach($listKegiatans as $listKegiatan)
                                            <td>
                                                ...
                                                {{ \App\Absen::whereSantriId($listSantri->id)->whereKegiatanId($listKegiatan->id)->whereKeterangan('hadir')->whereBetween('created_at', [$start_date, $end_date])->count() }}

                                            </td>
                                            <td>

                                                {{ \App\Absen::whereSantriId($listSantri->id)->whereKegiatanId($listKegiatan->id)->whereKeterangan('izin')->whereBetween('created_at', [$start_date, $end_date])->count() }}

                                            </td>
                                            <td>

                                                {{ \App\Absen::whereSantriId($listSantri->id)->whereKegiatanId($listKegiatan->id)->whereKeterangan('alfa')->whereBetween('created_at', [$start_date, $end_date])->count() }}
