...
class KeamananController extends Controller
{
    ...
    {
        $santri = Santri::orderBy('nama_santri', 'ASC')->with(['kelas', 'asrama.ngaran'])->whereStatus('aktif')->where('nama_santri', 'like', '%'.$request->nama_santri.'%' )->orWhere('nis', $request->nis)->get();
